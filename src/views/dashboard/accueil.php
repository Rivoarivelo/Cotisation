...
<div class="main-content container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header fw-bold text-darken text-center fs-6">
    ...
    <!-- DERNIERE ACTIVITER -->
    <div class="card mt-4">
        <div class="card-header fw-bold fs-6 text-darken text-center">
            Dernières activités
        </div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th>Action</th>
                    <!-- table active -->
                    <th class="table-active">Montant</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    <td><?= $a['date'] ?></td>
                    <td><?= $a['action'] ?></td>
                    <td class="text-success fw-bold table-active"><?= number_format($a['montant'],0,',',' ') ?> Ar</td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
