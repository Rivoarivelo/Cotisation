            ...
            <div class="col">
                <div class="card shadow-lg">
                    <div class="card-header  bg-darken text-white">
                        <h4 class="mb-0 text-white">Vérification Carte Membre</h4>
                    </div>
                        ...
                        <form method="post" action="<?= BASE_URL ?>index.php?controller=verification&action=verifier">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cin" name="cin"
                                    value="<?= htmlspecialchars($cin) ?>" required>
                            </div>

                            <div class="mb-3">
                                <label for="numcart" class="form-label">Numéro de carte</label>
                                <input type="text" class="form-control" id="numcart" name="numcart"
                                    value="<?= htmlspecialchars($numcart) ?>" required>
                            </div>
                            ...
                            <button type="submit" class="btn btn-darken w-100">Valider</button>
                        </form>
                    </div>
                </div>
