      ...
      <ul class="nxl-navbar d-flex row g-3">
        ...
        <li class="nxl-item nxl-hasmenu">
          ...
          <ul class="nxl-submenu">
            <li class="nxl-item"><a class="nxl-link fs-6" href="index.php?controller=paiement&action=add">Payer</a>
            </li>
            <li class="nxl-item"><a class="nxl-link fs-6" href="index.php?controller=paiement&action=index">Liste des
                payements</a></li>
          </ul>
        </li>
        <li class="nxl-item nxl-hasmenu">
          ...
          <ul class="nxl-submenu">
            <li class="nxl-item"><a class="nxl-link fs-6" href="index.php?controller=membre&action=add">Ajouter un
                membre</a></li>
            <li class="nxl-item"><a class="nxl-link fs-6" href="index.php?controller=membre&action=index">Rechercher
                un membre</a></li>
          </ul>
        </li>
        ...
        <li class="nxl-item nxl-hasmenu">
          <a href="index.php?controller=sync&action=syncOne" class="nxl-link">
            <span class="nxl-micon"><i class="feather-users"></i></span>
            <span class="nxl-mtext fs-6">Synchronisation</span><span class="nxl-arrow"><i class=""></i></span>
          </a>
        ...
        <li class="nxl-item nxl-hasmenu">
          ...
          <ul class="nxl-submenu">
            ...
            <li class="nxl-item"><a class="nxl-link fs-6" href="index.php?controller=responsable">Créer responsable</a>
            </li>
          </ul>
        </li>
        <?php endif; ?>
        <li class="nxl-item nxl-hasmenu">
          <a href="index.php?controller=sortiefond" class="nxl-link">
            <span class="nxl-micon"><i class="feather-users"></i></span>
            <span class="nxl-mtext fs-6">Sortie de fonds</span><span class="nxl-arrow"><i class=""></i></span>
          </a>
        </li>
        <li class="nxl-item nxl-hasmenu">
