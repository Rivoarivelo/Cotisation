          ...
          <div class="card-body">
            ...
            <form method="post" class="card p-3 border border-1 border-dark mb-4">
              ...
              <div class="mb-3">
                ...
                <input type="date" name="datepaiement" class="form-control border border-1 border-dark" required>
              </div>

              <!-- MONTANT -->
              <div class="mb-3">
                <label class="form-label">Montant</label>
                <input type="number" name="montant" id="montant" class="form-control border border-1 border-dark"
                  required>
              ...
              <div class="mb-3">
                ...
                <input type="number" id="dureeAffichee" class="form-control border border-1 border-dark" readonly>
              ...
              <div class="mb-3">
                ...
                <input type="number" step="0.01" name="montant_recu" class="form-control border border-1 border-dark">
              </div>
              ...
              <!--Afficher le nom responsable connecté avec condition php -->
              <?php if ($_SESSION['user']['role'] == 'ADMIN') {
        // Afficher le nom du responsable connecté
        echo "<div class='mb-3'><label class='form-label'>Responsable</label><input type='text' class='form-control border border-1 border-dark' value='" . $_SESSION['user']['role'] . "' readonly></div>";
      } ?>
